var lang = {
  ...
  "NO" : ["No", "Нет", "Ні"],
  "YES" : ["Yes", "Да", "Так"],
  "THE_TITLE_OF_1" : ["Level of understanding", "Уровень понимания", "Рівень розуміння"],
  "THE_TEXT_OF_1" : ["Please estimate the level of understanding.", "Выберите, пожалуйста, уровень понимания доклада.", "Оберіть, будь ласка, рівень розуміння доповіді."],
  "THE_TITLE_OF_2" : ["Level of relevance", "Уровень актуальности", "Рівень актуальності"],
  "THE_TEXT_OF_2" : ["Please estimate the level of relevance for you?", "Оцените, пожалуйста, актуальность темы для Вас?", "Оцініть, будь ласка, рівень актуальності теми для Вас?"],
  "THE_TITLE_OF_3" : ["Level of interest", "Уровень интереса", "Рівень цікавості"],
  "THE_TEXT_OF_3" : ["Please estimate the level of interest for you?", "Пожалуйста, оцените на сколько Вам интересна тема?", "Будь ласка, оцініть на скільки Вам цікава тема?"],
